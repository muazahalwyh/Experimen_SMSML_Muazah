...
def preprocess_data(df, target_col):
    ...
    X_train_resampled.to_csv("Preprocessing/Dataset/X_train_resampled.csv", index=False)
    X_test.to_csv("Preprocessing/Dataset/X_test.csv", index=False)
    y_train_resampled.to_csv("Preprocessing/Dataset/y_train_resampled.csv", index=False)
